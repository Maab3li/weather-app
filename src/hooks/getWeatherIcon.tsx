        ...
        try {
            for(let weaCode=0;weaCode<weatherCode.length;weaCode++) {
                if(weatherCode[weaCode] == 0 || weatherCode[weaCode] == 1) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-sunny.webp');
                }
                else if(weatherCode[weaCode] == 2) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-partly-cloudy.webp');
                }
                else if(weatherCode[weaCode] == 3) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-overcast.webp');
                }
                else if(weatherCode[weaCode] == 45 || weatherCode[weaCode] == 48) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-fog.webp');
                }
                else if(weatherCode[weaCode] == 51 || weatherCode[weaCode] == 53 || weatherCode[weaCode] == 55) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-drizzle.webp');
                }
                    ...
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-rain.webp');
                }
                    ...
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-snow.webp');
                }

                else if(weatherCode[weaCode] == 95 || weatherCode[weaCode] == 96 || weatherCode[weaCode] == 99) {
                    weatherIcons[weaCode] = ('/weather-app/tree/master/src/assets/images/icon-storm.webp');
                }
            }
            return weatherIcons
            }
